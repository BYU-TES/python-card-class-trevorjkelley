...
deck = []#create a list to store your cards in
for s in suits:
    for r in ranks:
...
for c in deck:
    print(c) #c is a card in the deck, each time this loop repeates then it will call the __str__ method from the Card class
